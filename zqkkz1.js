    ...
    console.log(`共${zqlookStartbodyArr.length}个看看赚body`)
	        for (let k = 0; k < zqlookStartbodyArr.length; k++) {
                ...
                console.log(`--------第 ${k + 1} 次看看赚激活执行中--------\n`)
                    await lookStart()
                await $.wait(Math.round(Math.random()*(300000-100000)+100000));
                console.log("\n\n")
            }
	        ...
	        for (let k = 0; k < zq_cookieArr.length; k++) {
                ...
                zq_cookie1= cookie_id  +'&device_brand=Android&device_id=54962995&device_model=PDVM00&device_platform=android&device_type=android&inner_version=202203071018&mi=0&openudid=a6066063b6fbed67&os_api=22&os_version=R9tm_11_A.53_191217&phone_network=WIFI&phone_sim=1'+'&request_time=' + time1 +'&time=' + time1 +'&'+ bodyVal
...
function openbox(id,zq_cookie1,timeout=0) {
    ...
    'Host': 'kandian.wkandian.com',
     ...
     'Referer':'https://kandian.wkandian.com/h5/20190527watchMoney/?keyword_wyq=woyaoq.com&access=WIFI&app-version=4.0.0&app_version=4.0.0&carrier=%E4%B8%AD%E5%9B%BD%E7%A7%BB%E5%8A%A8&channel=c1031&'+zq_cookie1},
            }
