...
function openbox(zq_cookie1,cookie_id,time,k,timeout = 0) {
    return new Promise((resolve) => {
        let url = {
            ...
            headers : {'Host': 'kandian.wkandian.com',
                'User-Agent': 'Mozilla/5.0 (Linux; Android 11; PDVM00 Build/RKQ1.201217.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/83.0.4103.106 Mobile Safari/537.36',
